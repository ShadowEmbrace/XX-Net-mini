...
使用说明:
   ...
   Windows: [XX-Net-mini-win10-x64.rar](https://github.com/miketwes/miketwes.github.io/blob/main/file/XX-Net-mini-win10-x64.rar) 集成了最新版本的Python 和 openssl,  Win10_x64用户解压后运行start.bat 
